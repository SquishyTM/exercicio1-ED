...
- Entreguem via Google Classroom. Vocês podem entregar (num Google Doc) o link do repositório do GitHub que contém a solução, ou fazer o upload de um zip contendo o código-fonte da solução. 
